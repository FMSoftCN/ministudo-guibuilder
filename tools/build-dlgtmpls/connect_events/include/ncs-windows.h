...
/** define the function for ID_MAINWND3 */
extern NCS_WND_EXPORT 
mMainWnd * ntCreateMainwnd3Ex(HPACKAGE package, HWND hParent, HICON h_icon, HMENU h_menu, DWORD user_dat);
#define ntCreateMainwnd3(package, hParent, user_data) \
	ntCreateMainwnd3Ex(package, hParent, (HICON)0, (HMENU)0, (DWORD)(user_data))


/** define the function for ID_MAINWND2 */
extern NCS_WND_EXPORT 
mMainWnd * ntCreateMainwnd2Ex(HPACKAGE package, HWND hParent, HICON h_icon, HMENU h_menu, DWORD user_dat);
#define ntCreateMainwnd2(package, hParent, user_data) \
	ntCreateMainwnd2Ex(package, hParent, (HICON)0, (HMENU)0, (DWORD)(user_data))
